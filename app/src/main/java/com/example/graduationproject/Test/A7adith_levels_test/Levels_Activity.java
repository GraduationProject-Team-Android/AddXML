...
//size of gradesssss .
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        levels_list = new ArrayList<String>();
        ...
        Call<Get_Grades_json> call = api_interface.getGrades("Bearer" + " 581|3EbpWw94YjnrjRJ3DLE8bP9NsEHRKli0eanoN81H", 3);
        call.enqueue(new Callback<Get_Grades_json>() {
            @Override
             ...
             levels_rating_list.add(new Levels_Rating_Grade(levels_list.get(i),response.body().getGrades().get(i).getPivot().getGrade()));
                ...
                recycler_adapter_levels = new Recycler_Adapter_Levels(Levels_Activity.this ,levels_rating_list, new OnClickListener_Levels() {
                    ...
                    public void onClick(int position) {
                        ...
                        intent.putExtra("levelId", position + 11);
